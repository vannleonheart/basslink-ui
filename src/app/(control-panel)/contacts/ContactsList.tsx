...
import { GroupedContacts, selectFilteredContactList, selectGroupedFilteredContacts } from './ContactsApi';
import { ClientContact } from '@/types';

function ContactsList({ data, isLoading }: { data: ClientContact[]; isLoading: boolean }) {

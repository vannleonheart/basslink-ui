...
export default function Content({ remittance, isLoading, accessToken, side }: ContentProps) {
	...
	const [acceptSubmittedRemittance] = apiService.useAcceptSubmittedRemittanceMutation();
	...
	const handleAcceptSubmission = async () => {
		dispatch(
			openDialog({
				children: (
					<DialogConfirm
						message="Apakah yakin akan menerima pengiriman ini?"
						onConfirm={async () => {
							const { error } = await acceptSubmittedRemittance({ id: remittance.id, side, accessToken });
	...
	return (
		...
		remittance && (
			<div className="mt-28 flex flex-col gap-12">
				...
				<div className="flex flex-col gap-6 bg-white p-12 rounded shadow">
							...
							<div className="flex flex-col gap-16">
										...
										<div className="flex flex-col gap-4">
											<div className="flex gap-4 items-center items-center justify-between">
												...
												<Typography className="w-full md:w-1/2 font-medium text-right">
													{userTypes[remittance.from_sender_type] ||
														remittance.from_sender_type}
												</Typography>
											</div>
											<div className="flex gap-4 items-center items-center justify-between">
											...
											<div className="flex gap-4 items-center justify-between items-start">
												...
												<Typography className="w-full md:w-1/2 font-medium text-right">
													{remittance.from_registered_address},{' '}
													{remittance.from_registered_city},{' '}
									...
									<div className="bg-gray-200 p-12 rounded flex flex-col gap-12">
										...
										<div className="flex flex-col gap-4">
											...
											<div className="flex gap-4 items-center items-center justify-between">
												...
												<Typography className="w-full md:w-1/2 font-medium text-right">
													{remittance.to_address}, {remittance.to_city},{' '}
													{remittance.to_region},{' '}
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-16">
									<div className="bg-gray-200 p-12 rounded flex flex-col gap-8">
										...
										<Typography>
											{purposeTypes[remittance.purpose] || remittance.purpose}
										</Typography>
									</div>
									<div className="bg-gray-200 p-12 rounded flex flex-col gap-8">

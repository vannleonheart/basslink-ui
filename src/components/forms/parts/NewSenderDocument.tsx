...
import { CreateSenderDocumentFormData } from '@/types/form';
import { Button, MenuItem, TextField } from '@mui/material';
import FuseSvgIcon from '@fuse/core/FuseSvgIcon';
import { DocumentTypes } from '@/data/static-data';

type NewSenderDocumentProps = {
	value: CreateSenderDocumentFormData[];
	onChange: (value: CreateSenderDocumentFormData[]) => void;
};

export default function NewSenderDocument({ value, onChange }: NewSenderDocumentProps) {
	...
	const handleDocumentChange = (index: number, newValue: CreateSenderDocumentFormData) => {
...
type SenderDocumentProps = {
	value?: CreateSenderDocumentFormData;
	onChange?: (value: CreateSenderDocumentFormData) => void;
	onRemove?: () => void;
};

function SenderDocument({ value, onChange, onRemove }: SenderDocumentProps) {
	...
	const onSubmit = (data: CreateSenderDocumentFormData) => {
		onChange?.(data);
	};
